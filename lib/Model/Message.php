...
class Message implements ArrayAccess
{
    ...
    /**
     * Sets message_text
     * @param string $message_text Mensagem de resposta
     * @return $this
     */
    ...
    /**
     * Sets message_code
     * @param string $message_code REQUIRED_FIELD(-1)<br> INVALID_DATA(-2)<br>GENERAL_EXCEPTION(-3)<br>BUSINESS_EXCEPTION(-4)<br>TIMEOUT_EXCEPTION(-5)<br>SYSTEM_EXCEPTION(-6)
     * @return $this
     */
